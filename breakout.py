...
class Breakout(Game):
    def __init__(self):
        Game.__init__(self, 'Break~Through', c.screen_width, c.screen_height, c.background_image, c.frame_rate)
